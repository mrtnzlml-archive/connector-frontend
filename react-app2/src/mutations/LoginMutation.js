...
class LoginMutation extends Relay.Mutation {
	...
	// implements a mutation type named ‘login’.
	getMutation() {
		return Relay.QL`
			mutation {
				login(input: $input)
	...
	// input to the mutation. Our ‘login’ mutation takes exactly
	// two variables as input – username and password.
	getVariables() {
		return {
	...
	// These configurations advise Relay on how to handle the LoginPayload
